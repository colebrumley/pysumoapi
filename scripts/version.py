...
def main() -> None:
    ...
    parser.add_argument(
        "action", choices=["show", "bump", "set"], help="Action to perform"
    )
    parser.add_argument(
        "--type",
    ...
    parser.add_argument("--version", help="New version (for 'set' action)")
    ...
    if args.action == "show":
        ...
        print(
            f"Don't forget to commit the changes and create a tag: git tag v{new_version}"
        )
        ...
        print(
            f"Don't forget to commit the changes and create a tag: git tag v{args.version}"
        )
