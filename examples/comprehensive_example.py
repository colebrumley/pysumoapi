...
from pysumoapi.models import Rikishi, RikishiStats
...
async def get_rikishi_career_summary(client: SumoClient, rikishi_id: int) -> dict:
    ...
    measurements = await client.get_measurements(rikishi_id=rikishi_id, sort_order="asc")
    ...
    async with SumoClient() as client:
        try:
            ...
            for division in ["Makuuchi", "Juryo", "Makushita", "Sandanme"]:
                print(f"\n{division}:")
                print(f"  Total Matches: {stats.total_by_division.__dict__[division]}")
                print(f"  Wins: {stats.wins_by_division.__dict__[division]}")
                print(f"  Losses: {stats.loss_by_division.__dict__[division]}")
                print(f"  Absences: {stats.absence_by_division.__dict__[division]}")
                print(f"  Yusho: {stats.yusho_by_division.__dict__[division]}")
